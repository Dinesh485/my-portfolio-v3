...
const Contact = () => {
    return ( 
        <Section extend={'xl:w-[fit-content] xl:min-w-[fit-content] xl:min-h-[auto] xl:h-[fit-content] xl:fixed  xl:left-10 2xl:left-16 xl:bottom-10 xl:m-0 xl:z-50'} id = {'contact'}>
